...
<html lang="en">
    ...
    <body>
        ...
        <div class="back-to-home rounded d-none d-sm-block">
            <a href="home.jsp" class="btn btn-icon btn-success"><i data-feather="home" class="icons"></i></a>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="login" method="post" class="login-form mt-4">                                        <div class="col-lg-12">
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="d-grid">
                                            <a href="#" class="btn" style="color: #2CA052;"><i class="uil uil-google"></i> Google</a>
                                        </div>
                                    </div>
