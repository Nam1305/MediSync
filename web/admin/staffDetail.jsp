                    ...
                    <div class="card mt-4 p-4 feedback-section">
                        ...
                        <div class="review-header">
                            ...
                            <div class="sort-options">
                                <a href="ViewStaffDetail?id=${staff.staffId}&star=${star}${hasComment ? '&hasComment=true' : ''}&sort=desc" class="sort-button ${param.sort == 'desc' || param.sort == null ? 'active' : ''}">Mới nhất</a> | 
                                <a href="ViewStaffDetail?id=${staff.staffId}&star=${star}${hasComment ? '&hasComment=true' : ''}&sort=asc" class="sort-button ${param.sort == 'asc' ? 'active' : ''}">Cũ nhất</a>
                            </div>
                        </div>
