 ...
 * @author Acer
 */
@WebServlet(name = "ViewDepartmentDetailServlet", urlPatterns = {"/ViewDepartmentDetail"})
public class ViewDepartmentDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewDepartmentDetailServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewDepartmentDetailServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (department != null) {
            List<Integer> staffCount = departmentDao.countStaffByRole(departmentId);
